...
# aquest script fa un retall de tiff que volem, per a acumulades diàries i horàries. Treu un fitxer amb els dies sense dades.
# Treu l'acumulada mensual apartir de la diària
# acumulada de 24h
...
#       }
#     
#   filein_1h  <- paste0("/media/francesc/disc_extern_francesc/CMPAC1C_1h/",any,"/",mes,"/",dia,"/",
...
# 
# ##################### ini retallar ############################    
#         fileout_1h  <- paste0("/media/francesc/disc_extern_francesc/CMPAC1C_1h/",any,"/",mes,"/",dia,"/",
#                            "XXX_RN1_",any, #primer mes de 2013 el nom es diferent
#                            mes,
#                            dia,
#                            "_",
...
if(substr(date_old,6,7) != substr(date_new,6,7)){ # canvi de mes, escriu la suma mensual
