...
#date.ini <- as.Date(x = as.character(20190101), format = "%Y%m%d") #must be the first day of the month
#date.fin <- as.Date(x = as.character(20201231), format = "%Y%m%d") #must be the first day of the month
